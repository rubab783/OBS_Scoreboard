<div class="glass-card timer-control-card">
    ...
    <div class="timer-header">
        ...
        <span class="timer-status" id="timerStatusPill" data-status="{{ $match->timer_status }}">
    ...
    <div class="match-status-controls">
        ...
        <button
            class="status-btn {{ $match->status === 'live' ? 'active' : '' }}"
            data-status="live"
            type="button">
        ...
        <button
            class="status-btn {{ $match->status === 'paused' ? 'active' : '' }}"
            data-status="paused"
            type="button">
        ...
        <button
            class="status-btn {{ $match->status === 'ended' ? 'active' : '' }}"
            data-status="ended"
            type="button">
